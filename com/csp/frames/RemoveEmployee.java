...
public class RemoveEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        updateEmployeePanel.add(removeButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 470, 210, 30));
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        ...
        if (ed.removeEmployee(Integer.parseInt(idField.getText())) > 0) {
            JOptionPane.showMessageDialog(this, "Employee Removed!");
            count = 0;
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(this, "Employee Could Not Be Removed!");
        }
